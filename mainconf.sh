ubuntu16 () {
	...
	echo "" >> /etc/squid/squid.conf
	echo "# NOME DO SERVIDORasdasd" >> /etc/squid/squid.conf
	...
	echo "cache_mem 300 MB" >> /etc/squid/squid.conf
...
ubuntu () {
	...
	echo "" >> /etc/squid3/squid.conf
	echo "# NOME DO SERVIDORasdasd" >> /etc/squid3/squid.conf
	...
	echo "cache_mem 300 MB" >> /etc/squid3/squid.conf
...
debian () {
	...
	echo "" >> /etc/squid3/squid.conf
	echo "" >> /etc/squid3/squid.conf
	echo "VPN BERI" >> /etc/squid3/squid.conf
	echo "visible_hostname JoeLinux" >> /etc/squid3/squid.conf
	echo "" >> /etc/squid3/squid.conf
	echo "" >> /etc/squid3/squid.conf
	echo "# ACL DE CONEXAO" >> /etc/squid3/squid.conf
